...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-[#262626]'>
            <h1 className='text-3xl font-medium'>Найти по специальности</h1>
            <p className='sm:w-1/3 text-center text-sm'>Просто просмотрите наш обширный список надежных врачей и запишитесь на прием без лишних хлопот.</p>
